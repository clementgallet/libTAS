...
OVERRIDE FMOD_RESULT FMOD_EventSystem_GetSystemObject(void *eventsystem, void **system);
OVERRIDE FMOD_RESULT _ZN4FMOD11EventSystem15getSystemObjectEPPNS_6SystemE(void *eventsystem, void **system);

OVERRIDE FMOD_RESULT FMOD_System_SetOutput(void *system, int output);
