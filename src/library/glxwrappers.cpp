...
/* Declare both orig::func and myfunc functions */ 
#define DECLARE_ORIG_MY_POINTER(FUNC) \
DECLARE_ORIG_POINTER(FUNC) \
extern decltype(&FUNC) my##FUNC;


DECLARE_ORIG_MY_POINTER(glClear)
DECLARE_ORIG_MY_POINTER(glBegin)
DECLARE_ORIG_MY_POINTER(glEnd)
DECLARE_ORIG_MY_POINTER(glVertex2d)
DECLARE_ORIG_MY_POINTER(glVertex2f)
DECLARE_ORIG_MY_POINTER(glVertex2i)
DECLARE_ORIG_MY_POINTER(glVertex2s)
DECLARE_ORIG_MY_POINTER(glVertex3d)
DECLARE_ORIG_MY_POINTER(glVertex3f)
DECLARE_ORIG_MY_POINTER(glVertex3i)
DECLARE_ORIG_MY_POINTER(glVertex3s)
DECLARE_ORIG_MY_POINTER(glVertex4d)
DECLARE_ORIG_MY_POINTER(glVertex4f)
DECLARE_ORIG_MY_POINTER(glVertex4i)
DECLARE_ORIG_MY_POINTER(glVertex4s)
DECLARE_ORIG_MY_POINTER(glVertex2dv)
DECLARE_ORIG_MY_POINTER(glVertex2fv)
DECLARE_ORIG_MY_POINTER(glVertex2iv)
DECLARE_ORIG_MY_POINTER(glVertex2sv)
DECLARE_ORIG_MY_POINTER(glVertex3dv)
DECLARE_ORIG_MY_POINTER(glVertex3fv)
DECLARE_ORIG_MY_POINTER(glVertex3iv)
DECLARE_ORIG_MY_POINTER(glVertex3sv)
DECLARE_ORIG_MY_POINTER(glVertex4dv)
DECLARE_ORIG_MY_POINTER(glVertex4fv)
DECLARE_ORIG_MY_POINTER(glVertex4iv)
DECLARE_ORIG_MY_POINTER(glVertex4sv)

DECLARE_ORIG_MY_POINTER(glDrawArrays)
DECLARE_ORIG_MY_POINTER(glDrawElements)
DECLARE_ORIG_MY_POINTER(glMultiDrawArrays)
DECLARE_ORIG_MY_POINTER(glMultiDrawElements)
DECLARE_ORIG_MY_POINTER(glDrawRangeElements)
DECLARE_ORIG_MY_POINTER(glDrawElementsBaseVertex)
DECLARE_ORIG_MY_POINTER(glDrawRangeElementsBaseVertex)
DECLARE_ORIG_MY_POINTER(glDrawElementsInstancedBaseVertex)
DECLARE_ORIG_MY_POINTER(glMultiDrawElementsBaseVertex)
DECLARE_ORIG_MY_POINTER(glDrawArraysInstancedBaseInstance)
DECLARE_ORIG_MY_POINTER(glDrawElementsInstancedBaseInstance)
DECLARE_ORIG_MY_POINTER(glDrawElementsInstancedBaseVertexBaseInstance)

DECLARE_ORIG_MY_POINTER(glDrawTransformFeedback)
DECLARE_ORIG_MY_POINTER(glDrawTransformFeedbackStream)
DECLARE_ORIG_MY_POINTER(glDrawTransformFeedbackInstanced)
DECLARE_ORIG_MY_POINTER(glDrawTransformFeedbackStreamInstanced)

DECLARE_ORIG_MY_POINTER(glDrawArraysInstancedARB)
DECLARE_ORIG_MY_POINTER(glDrawElementsInstancedARB)
DECLARE_ORIG_MY_POINTER(glDrawArraysInstancedEXT)
DECLARE_ORIG_MY_POINTER(glDrawElementsInstancedEXT)
DECLARE_ORIG_MY_POINTER(glDrawRangeElementsEXT)
DECLARE_ORIG_MY_POINTER(glMultiDrawArraysEXT)
DECLARE_ORIG_MY_POINTER(glMultiDrawElementsEXT)
DECLARE_ORIG_MY_POINTER(glDrawArraysEXT)
