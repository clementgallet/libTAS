...
#ifndef LIBTAS_ISTEAMUSERSTATS013_H_INCL
#define LIBTAS_ISTEAMUSERSTATS013_H_INCL

#include "isteamuserstats.h"

#include <stdint.h>
#define STEAMUSERSTATS_INTERFACE_VERSION_013 "STEAMUSERSTATS_INTERFACE_VERSION013"

namespace libtas {

struct ISteamUserStats013Vtbl
{
    ...
    unsigned int (*GetNumAchievements)();
    const char *(*GetAchievementName)( unsigned int iAchievement );
    ...
    bool (*GetAchievementProgressLimitsInt32)( const char *pchName, int32_t *pnMinProgress, int32_t *pnMaxProgress );
