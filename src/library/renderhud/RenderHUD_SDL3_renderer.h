...
#endif
{
    public:
/**
         * @class RenderHUD_SDL3_renderer
         * @brief SDL3 renderer-based HUD backend.
         *
         * Implements HUD rendering using the SDL3 rendering API.
         */
        ~RenderHUD_SDL3_renderer();

        /**
         * @brief Sets the SDL3 renderer used by the HUD backend.
         *
