...
typedef int InputType; enum {
    ...
    /* SDL Controller 1 */
    IT_CONTROLLER1_BUTTON_A = (1 << IT_CONTROLLER_ID_SHIFT),
    ...
    IT_CONTROLLER1_AXIS_LEFTX = (1 << IT_CONTROLLER_ID_SHIFT) | IT_CONTROLLER_AXIS_MASK,
    ...
    /* SDL Controller 2 */
    IT_CONTROLLER2_BUTTON_A = (2 << IT_CONTROLLER_ID_SHIFT),
    ...
    IT_CONTROLLER2_AXIS_LEFTX = (2 << IT_CONTROLLER_ID_SHIFT) | IT_CONTROLLER_AXIS_MASK,
    ...
    /* SDL Controller 3 */
    IT_CONTROLLER3_BUTTON_A = (3 << IT_CONTROLLER_ID_SHIFT),
    ...
    IT_CONTROLLER3_AXIS_LEFTX = (3 << IT_CONTROLLER_ID_SHIFT) | IT_CONTROLLER_AXIS_MASK,
    ...
    /* SDL Controller 4 */
    IT_CONTROLLER4_BUTTON_A = (4 << IT_CONTROLLER_ID_SHIFT),
    ...
    IT_CONTROLLER4_AXIS_LEFTX = (4 << IT_CONTROLLER_ID_SHIFT) | IT_CONTROLLER_AXIS_MASK,
