...
#define SDL_SetRenderClipRect reinterpret_cast<decltype(&libtas::sdl3::SDL_SetRenderClipRect)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_SetRenderClipRect))
#define SDL_SetRenderViewport reinterpret_cast<decltype(&libtas::sdl3::SDL_SetRenderViewport)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_SetRenderViewport))
#define SDL_GetRenderViewport reinterpret_cast<decltype(&libtas::sdl3::SDL_GetRenderViewport)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_GetRenderViewport))
#define SDL_RenderViewportSet reinterpret_cast<decltype(&libtas::sdl3::SDL_RenderViewportSet)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_RenderViewportSet))
#define SDL_RenderGeometryRaw reinterpret_cast<decltype(&libtas::sdl3::SDL_RenderGeometryRaw)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_RenderGeometryRaw))
#define SDL_GetRenderScale reinterpret_cast<decltype(&libtas::sdl3::SDL_GetRenderScale)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_GetRenderScale))
#define SDL_SetTextureScaleMode reinterpret_cast<decltype(&libtas::sdl3::SDL_SetTextureScaleMode)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_SetTextureScaleMode))
#define SDL_RenderClipEnabled reinterpret_cast<decltype(&libtas::sdl3::SDL_RenderClipEnabled)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_RenderClipEnabled))
#define SDL_GetRenderClipRect reinterpret_cast<decltype(&libtas::sdl3::SDL_GetRenderClipRect)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_GetRenderClipRect))
#define SDL_CreateTexture reinterpret_cast<decltype(&libtas::sdl3::SDL_CreateTexture)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_CreateTexture))
#define SDL_UpdateTexture reinterpret_cast<decltype(&libtas::sdl3::SDL_UpdateTexture)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_UpdateTexture))
#define SDL_SetTextureBlendMode reinterpret_cast<decltype(&libtas::sdl3::SDL_SetTextureBlendMode)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_SetTextureBlendMode))
#define SDL_DestroyTexture reinterpret_cast<decltype(&libtas::sdl3::SDL_DestroyTexture)>(*libtas::getOrigSDLFuncLoc(libtas::index_sdl3::SDL_DestroyTexture))
#define SDL_FColor libtas::sdl3::SDL_FColor
#define SDL_ScaleMode libtas::sdl3::SDL_ScaleMode



#define SDL_Rect libtas::sdl3::SDL_Rect
#define SDL_Color libtas::sdl3::SDL_Color
...
static void ImGui_ImplSDLRenderer3_DrawCallback_SetSamplerLinear(const ImDrawList*, const ImDrawCmd*)   { ImGui_ImplSDLRenderer3_Data* bd = ImGui_ImplSDLRenderer3_GetBackendData(); bd->CurrentScaleMode = libtas::sdl3::SDL_SCALEMODE_LINEAR; }
static void ImGui_ImplSDLRenderer3_DrawCallback_SetSamplerNearest(const ImDrawList*, const ImDrawCmd*)  { ImGui_ImplSDLRenderer3_Data* bd = ImGui_ImplSDLRenderer3_GetBackendData(); bd->CurrentScaleMode = libtas::sdl3::SDL_SCALEMODE_NEAREST; }
...
void ImGui_ImplSDLRenderer3_UpdateTexture(ImTextureData* tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate)
    {
        ...
        SDL_Texture* sdl_texture = SDL_CreateTexture(bd->Renderer, libtas::sdl3::SDL_PIXELFORMAT_RGBA32, libtas::sdl3::SDL_TEXTUREACCESS_STATIC, tex->Width, tex->Height);
        ...
        SDL_SetTextureBlendMode(sdl_texture, libtas::sdl3::SDL_BLENDMODE_BLEND);
        SDL_SetTextureScaleMode(sdl_texture, libtas::sdl3::SDL_SCALEMODE_LINEAR);
