...
KeyMapping::KeyMapping(void* c)
{
    ...
    hotkey_list.push_back({{SingleInput::IT_NONE, 0}, HOTKEY_SAVESTATE_BACKTRACK, "Save Backtrack State (obsolete)"});
    ...
    hotkey_list.push_back({{SingleInput::IT_NONE, 0}, HOTKEY_LOADSTATE_BACKTRACK, "Load Backtrack State (obsolete)"});
    ...
    hotkey_list.push_back({{SingleInput::IT_NONE, 0}, HOTKEY_LOADBRANCH_BACKTRACK, "Load Backtrack Branch (obsolete)"});
