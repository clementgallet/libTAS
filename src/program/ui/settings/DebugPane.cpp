...
void DebugPane::initLayout()
{
    ...
    logPrintLayout->addWidget(logPrintFrequentBox, 0, 1);
    logPrintLayout->addWidget(logPrintErrorBox, 0, 2);
    logPrintLayout->addWidget(logPrintWarningBox, 0, 3);
    logPrintLayout->addWidget(logPrintInfoBox, 1, 0);
    logPrintLayout->addWidget(logPrintTODOBox, 1, 1);
    logPrintLayout->addWidget(logPrintAVBox, 1, 2);
    logPrintLayout->addWidget(logPrintCheckpointBox, 1, 3);
    logPrintLayout->addWidget(logPrintEventsBox, 2, 0);
    logPrintLayout->addWidget(logPrintIOBox, 2, 1);
    logPrintLayout->addWidget(logPrintHookBox, 2, 2);
    logPrintLayout->addWidget(logPrintJoystickBox, 2, 3);
    logPrintLayout->addWidget(logPrintKeyboardBox, 3, 0);
    logPrintLayout->addWidget(logPrintLocaleBox, 3, 1);
    logPrintLayout->addWidget(logPrintMouseBox, 3, 2);
    logPrintLayout->addWidget(logPrintGLBox, 3, 3);
    logPrintLayout->addWidget(logPrintRandomBox, 4, 0);
    logPrintLayout->addWidget(logPrintSDLBox, 4, 1);
    logPrintLayout->addWidget(logPrintSignalsBox, 4, 2);
    logPrintLayout->addWidget(logPrintSleepBox, 4, 3);
    logPrintLayout->addWidget(logPrintSocketBox, 5, 0);
    logPrintLayout->addWidget(logPrintSoundBox, 5, 1);
    logPrintLayout->addWidget(logPrintSteamBox, 5, 2);
    logPrintLayout->addWidget(logPrintSystemBox, 5, 3);
    logPrintLayout->addWidget(logPrintTimeGetBox, 6, 0);
    logPrintLayout->addWidget(logPrintTimeSetBox, 6, 1);
    logPrintLayout->addWidget(logPrintTimersBox, 6, 2);
    logPrintLayout->addWidget(logPrintThreadsBox, 6, 3);
    logPrintLayout->addWidget(logPrintWaitBox, 7, 0);
    logPrintLayout->addWidget(logPrintWindowsBox, 7, 1);
    logPrintLayout->addWidget(logPrintWineBox, 7, 2);
    ...
    logExcludeLayout->addWidget(logExcludeFrequentBox, 0, 1);
    logExcludeLayout->addWidget(logExcludeErrorBox, 0, 2);
    logExcludeLayout->addWidget(logExcludeWarningBox, 0, 3);
    logExcludeLayout->addWidget(logExcludeInfoBox, 1, 0);
    logExcludeLayout->addWidget(logExcludeTODOBox, 1, 1);
    logExcludeLayout->addWidget(logExcludeAVBox, 1, 2);
    logExcludeLayout->addWidget(logExcludeCheckpointBox, 1, 3);
    logExcludeLayout->addWidget(logExcludeEventsBox, 2, 0);
    logExcludeLayout->addWidget(logExcludeIOBox, 2, 1);
    logExcludeLayout->addWidget(logExcludeHookBox, 2, 2);
    logExcludeLayout->addWidget(logExcludeJoystickBox, 2, 3);
    logExcludeLayout->addWidget(logExcludeKeyboardBox, 3, 0);
    logExcludeLayout->addWidget(logExcludeLocaleBox, 3, 1);
    logExcludeLayout->addWidget(logExcludeMouseBox, 3, 2);
    logExcludeLayout->addWidget(logExcludeGLBox, 3, 3);
    logExcludeLayout->addWidget(logExcludeRandomBox, 4, 0);
    logExcludeLayout->addWidget(logExcludeSDLBox, 4, 1);
    logExcludeLayout->addWidget(logExcludeSignalsBox, 4, 2);
    logExcludeLayout->addWidget(logExcludeSleepBox, 4, 3);
    logExcludeLayout->addWidget(logExcludeSocketBox, 5, 0);
    logExcludeLayout->addWidget(logExcludeSoundBox, 5, 1);
    logExcludeLayout->addWidget(logExcludeSteamBox, 5, 2);
    logExcludeLayout->addWidget(logExcludeSystemBox, 5, 3);
    logExcludeLayout->addWidget(logExcludeTimeGetBox, 6, 0);
    logExcludeLayout->addWidget(logExcludeTimeSetBox, 6, 1);
    logExcludeLayout->addWidget(logExcludeTimersBox, 6, 2);
    logExcludeLayout->addWidget(logExcludeThreadsBox, 6, 3);
    logExcludeLayout->addWidget(logExcludeWaitBox, 7, 0);
    logExcludeLayout->addWidget(logExcludeWindowsBox, 7, 1);
    logExcludeLayout->addWidget(logExcludeWineBox, 7, 2);
