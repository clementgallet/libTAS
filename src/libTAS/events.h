 ...
 */
OVERRIDE void SDL_SetEventFilter(SDL_EventFilter filter, ...);

/**
 *  Return the current event filter - can be used to "chain" filters.
 *  The prototype of this function in SDL 1.2 and SDL 2 is different,
 *  including the return type. So we must declare the function as a
 *  pointer and dynamically points it to the right function.
 */
extern void* SDL_GetEventFilter;
