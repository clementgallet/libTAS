...
DEFINE_ORIG_POINTER(SDL_CreateMutex);
DEFINE_ORIG_POINTER(SDL_LockMutex);
DEFINE_ORIG_POINTER(SDL_TryLockMutex);
DEFINE_ORIG_POINTER(SDL_UnlockMutex);
DEFINE_ORIG_POINTER(SDL_DestroyMutex);
DEFINE_ORIG_POINTER(SDL_CreateSemaphore);
DEFINE_ORIG_POINTER(SDL_DestroySemaphore);
DEFINE_ORIG_POINTER(SDL_SemWait);
DEFINE_ORIG_POINTER(SDL_SemTryWait);
DEFINE_ORIG_POINTER(SDL_SemWaitTimeout);
DEFINE_ORIG_POINTER(SDL_SemPost);
DEFINE_ORIG_POINTER(SDL_SemValue);
DEFINE_ORIG_POINTER(SDL_CreateCond);
DEFINE_ORIG_POINTER(SDL_DestroyCond);
DEFINE_ORIG_POINTER(SDL_CondSignal);
DEFINE_ORIG_POINTER(SDL_CondBroadcast);
DEFINE_ORIG_POINTER(SDL_CondWait);
DEFINE_ORIG_POINTER(SDL_CondWaitTimeout);

/* Override */ SDL_mutex* SDL_CreateMutex(void)
{
    DEBUGLOGCALL(LCF_WAIT | LCF_SDL);
