...
LIB_SOURCE_FILES="libTAS.c keyboard.c hook.c logging.c openal.c threads.c dumpvideo.c time.c ../shared/tasflags.c"
...
C_OPTIMISATIONS="-g -O1 -lX11 -lavcodec -lswscale -lavformat"
